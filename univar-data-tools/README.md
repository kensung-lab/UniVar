...
## Description
This repository contain all the essential program to init the UniVar [mongoDB][mongo-db]

## Submodule
1. `univar-gene-db` (To import the UniVar gene Database)
2. `hpo-converter` (To import the HPO terms information to UniVar Database)
3. `import-gene-panel` (To import the gene panel to UniVar Database)
