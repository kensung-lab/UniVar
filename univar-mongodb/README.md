...
### Description
This [repository][github-repositories] contain all the script and docker for UniVar mongoDB

## Requirements
1. [Docker][docker] 28.4.0+

## Require file
1. mongo-root-password (which include the password of root for [mongoDB][mongo-db])
