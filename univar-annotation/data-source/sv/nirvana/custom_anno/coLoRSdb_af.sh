...
# 2. download the CoLoRSdb.GRCh38.v1.0.0.pbsv.jasmine.vcf.gz from https://zenodo.org/records/14814308 and locate it as the variable SRC_FILE below
if [ -z "$1" ]; then
...
FILE=CoLoRSdb.GRCh38.v1.2.0.pbsv.jasmine.vcf.gz
